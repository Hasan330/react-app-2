...
function mapDispatchToProps(dispatch) {
	//Whenever selectBook is called, the result should be dispatched to all of our reducers
...
export default connect(mapStatesToProps, mapDispatchToProps)(BookList);